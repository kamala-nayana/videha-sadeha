...
The historical source PDFs are never modified. Runtime hardenings add authenticated
...
def fetch_engine(url: str, attempts: int = 4) -> str:
    ...
    headers = auth_headers({"User-Agent": "Videha-PDF-UA-Remediator-Launcher/2.6"})
